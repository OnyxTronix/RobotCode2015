...
public class OI {
    ...
    public JoystickButton stopWheelsButton2;
    ...
    public OI() {
        ...
        stopWheelsButton = new JoystickButton(driveStick, 5);
        stopWheelsButton.whenPressed(new StopCollectorWheels());
        stopWheelsButton2 = new JoystickButton(driveStick, 6);
        stopWheelsButton2.whenPressed(new StopCollectorWheels());

        insertCrateButton = new JoystickButton(driveStick, 1);
        insertCrateButton.whenPressed(new InsertCrate());		//for robot b
        insertWithWheelsButton = new JoystickButton(driveStick, 2);
        insertWithWheelsButton.whileHeld(new InsertWithWheels());
...
//        rotateLeftButton.whileHeld(new RotateLeft());
        spinRightButton = new JoystickButton(driveStick, 8);
        spinRightButton.whileHeld(new SpinWheelsRight());
        spinLeftButton = new JoystickButton(driveStick, 7);
