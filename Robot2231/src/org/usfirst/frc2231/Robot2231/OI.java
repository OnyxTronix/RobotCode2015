...
public class OI {
    ...
    public JoystickButton insertWithWheelsButton;
    public JoystickButton removeWithWheelsButton;
    ...
    public OI() {
        ...
        stopWheelsButton = new JoystickButton(driveStick, 7);
        stopWheelsButton.whenPressed(new StopCollectorWheels());
        removeWithWheelsButton = new JoystickButton(driveStick, 4);
        removeWithWheelsButton.whenPressed(new RemoveWithWheels());
        insertWithWheelsButton = new JoystickButton(driveStick, 3);
        insertWithWheelsButton.whenPressed(new InsertWithWheels());
        closeWheelsButton = new JoystickButton(driveStick, 2);
        closeWheelsButton.whenPressed(new CloseWheels());
        openWheelsButton = new JoystickButton(driveStick, 1);
