...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("BoxLongCollect", new BoxLongCollect());

        SmartDashboard.putData("BoxShortCollect", new BoxShortCollect());

        SmartDashboard.putData("DumpsterCollect", new DumpsterCollect());

        SmartDashboard.putData("railMoveByJoystick", new railMoveByJoystick());
