...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("DriveTrain", "left", (Talon) frontLeft);
        
        rearLeft = new Talon(2);
        LiveWindow.addActuator("DriveTrain", "left", (Talon) rearLeft);
        
        frontRight = new Talon(1);
        LiveWindow.addActuator("DriveTrain", "right", (Talon) frontRight);
        
        rearRight = new Talon(0);
        LiveWindow.addActuator("DriveTrain", "right", (Talon) rearRight);
        
        driveTraindrive = new RobotDrive(frontLeft, rearLeft, frontRight, rearRight);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        driveTrainRightEncoder = new Encoder(0, 1, true, EncodingType.k4X);
        LiveWindow.addSensor("DriveTrain", "leftEncoder", driveTrainRightEncoder);
