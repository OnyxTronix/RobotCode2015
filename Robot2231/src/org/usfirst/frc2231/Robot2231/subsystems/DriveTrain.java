...
public class DriveTrain extends Subsystem {
    ...
    //TODO: use actual numbers from robot testing
    final double criticAccel = -0.5;
    final double desiredMotorAccel=-0.2;
    final double desiredPercentMotorAccel=0.9;
    double desiredSpeed;
    ...
    //WARNING: NOT TESTED YET 6/2/2015
    public void arcadeDrive(Joystick stick,double accel,double motorSpeed) {
    	if(stick.getRawAxis(LEFT_AXIS_INDEX)<=0 && accel<criticAccel && motorSpeed>stick.getRawAxis(LEFT_AXIS_INDEX))
    	{
    		if(isFirstTime)
    		{
    			desiredSpeed = (motorSpeed+desiredMotorAccel)*desiredPercentMotorAccel;
    			isFirstTime=false;
    		}
    		if((motorSpeed+desiredMotorAccel)*desiredPercentMotorAccel<=desiredSpeed)
    			desiredSpeed = (motorSpeed+desiredMotorAccel)*desiredPercentMotorAccel;
    		drive.arcadeDrive(desiredSpeed, -stick.getRawAxis(RIGHT_AXIS_INDEX));
    	}
    	else
    	{
