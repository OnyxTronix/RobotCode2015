...
public class DriveTrain extends Subsystem {
    ...
    public boolean isMovingForward(){
		return frontLeft.get() < 0 && frontRight.get() > 0 && rearLeft.get() < 0 && rearRight.get() > 0;
	}
    ...
    public void stopGradually()
    {
    	if (isMovingForward())
    	{
    		double currentSpeed = Math.abs(frontLeft.get());
	    	while (currentSpeed >= 0.2)
	    	{
	    		currentSpeed -= 0.02;
	    		System.out.println("Current Speed: " + currentSpeed);
	    		frontLeft.set(-currentSpeed);
	    		frontRight.set(currentSpeed);
	    		rearLeft.set(-currentSpeed);
	    		rearRight.set(currentSpeed);
	    		try
	    		{
	    			Thread.sleep(100);
	    		}
    ...
    {
    	return Math.min(Math.min(frontLeft.get(), frontRight.get()), Math.min(rearLeft.get(), rearRight.get()));
    }
	
	public void displayToSmartDashboard() {
		SmartDashboard.putNumber("Right Encoder Distance: ",
				posRight());
		System.out.println("Right Encoder Distance: " + posRight());
		}
}
