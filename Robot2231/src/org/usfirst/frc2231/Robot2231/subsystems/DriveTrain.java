...
public class DriveTrain extends Subsystem {
    ...
    public void stopGradually(Joystick stick)
    {
    	if (isMoving(stick))
    	{
    		...
    		{
    			currentSpeed -= 0.1;
    			this.frontRight.set(currentSpeed);
    			this.rearRight.set(currentSpeed);
    			this.frontLeft.set(-currentSpeed);
    			this.rearLeft.set(-currentSpeed);
    			try
    			{
    				Thread.sleep(100);
    			}
    ...
    {
    	if ((this.rearLeft.get() != 0 || this.rearRight.get() != 0 || this.frontLeft.get() != 0 || this.frontRight.get() != 0))
    		return true;
    	return false;
    }
}
