...
public class Stackevator extends Subsystem {
    ...
    DigitalInput bottomSwitch = RobotMap.stackevatorbottomSwitch;
...
//    	if(!this.topSwitch.get() || !this.bottomSwitch.get()){
    	if (!this.bottomSwitch.get()){
    		double setValue = 0;
//    		if(!this.topSwitch.get())
//    			setValue += stick.getRawAxis(3);
//    		if(!this.bottomSwitch.get())
//    			setValue -= stick.getRawAxis(2);
    		this.set(setValue);
    	}
    	else    	
