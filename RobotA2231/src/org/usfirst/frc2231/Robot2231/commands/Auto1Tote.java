...
public class Auto1Tote extends CommandGroup {
    ...
    public  Auto1Tote() {
    	...
    	addSequential(new AutoTurnRightWithTime(AutonomousConfig.TURN_RIGHT_TIME));
    	addSequential(new AutoDriveForwardWithTime(AutonomousConfig.DRIVE_TO_AUTO_ZONE_TIME));
        // Add Commands here:
