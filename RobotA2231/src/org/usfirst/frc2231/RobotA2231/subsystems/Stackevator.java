...
public class Stackevator extends PIDSubsystem {
    ...
    final double LOWER_SPEED = -0.7;
    final double RAISE_SPEED = 1.0;
    
    public static final double LEVEL_1_POSITION = 400;
    public static final double LEVEL_2_POSITION = 800;
    public static final double LEVEL_CAN_POSITION = 800;
...
//    	return false;
    	//TODO restore when microswitch is attached
    ...
    public void displayToSmartDashbaord() {
		...
		SmartDashboard.putBoolean("top microswitch", reachedTop());
